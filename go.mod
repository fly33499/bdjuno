...
replace (
	// alpha8이 0.45.9 이기 때문에 최신임
	github.com/firmachain/firmachain => github.com/fly33499/firmachain-1 v0.3.5-alpha8

	// juno 레벨에서 해결해야되는 문제가 많을 수 있다.
	github.com/forbole/juno/v3 => github.com/fly33499/juno/v3 v3.10.25
